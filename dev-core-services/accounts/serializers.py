...
class SocialLoginFrontendDataSerializer(serializers.Serializer):
...
class CustomUserSocialRegistrationSerializer(serializers.ModelSerializer):
    class Meta:
        model = CustomUser
        fields = ('username', 'email', 'firstname', 'password')  # Add other fields as needed
...
class VendorDetailsSerializer(serializers.Serializer):
    ...
    adress1 = serializers.CharField()
    adress2 = serializers.CharField()
    adress3 = serializers.CharField()
